...
class Consensus_C(gym.Env):
    ...
    def __init__(self, num_agents=5, num_iterations=40, dt=0.5):
    ...
    def step(self, action):
        ...
        if not done:
            ...
            if self.all_within_epsilon and trigger_count == 0:
                ...
                reward = - trigger_count * 0.01 * self.num_iterations 
            else:
                reward = - 50 * np.abs(average_position_difference) - trigger_count * 0.01 * self.num_iterations
            ...
            if self.time_to_reach_epsilon is not None:
                ...
                #reward = - 5 * self.time_to_reach_epsilon
                reward = 300 - 5 * self.time_to_reach_epsilon
            else:
                trigger_counts = 200
                reward = -5000
