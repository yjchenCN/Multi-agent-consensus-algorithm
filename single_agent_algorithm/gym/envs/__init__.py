...
register(
    id='MyEnv-v1',
    entry_point='gym.envs.classic_control:MyEnv1',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    id='MyEnv-v2',
    entry_point='gym.envs.classic_control:MyEnv2',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    id='Consensus-v1',
    entry_point='gym.envs.classic_control:Consensus1',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    id='Consensus-v3',
    entry_point='gym.envs.classic_control:Consensus_C',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    id='Consensus-v4',
    entry_point='gym.envs.classic_control:Consensus_D_F',
    #max_episode_steps=200,
    #reward_threshold=195.0,
)
